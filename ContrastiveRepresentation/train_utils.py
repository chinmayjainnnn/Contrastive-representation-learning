...
def calculate_loss(
    ...
    criterian = torch.nn.NLLLoss() #neg log liklihood loss
...
def fit_model(
    ...
    if args.mode == 'fine_tune_linear':
        for i in range(args.num_iters):
            train_loss, train_acc, val_loss, val_acc = fit_linear_model(classifier, X_train, y_train, X_val, y_val, args.num_iters, args.lr, args.batch_size, args.l2_lambda, args.grad_norm_clip, is_binary=False)
